...
\usepackage[section]{algorithm}                       % Floating-Umgebung für Algorithmen
\usepackage[noend]{algpseudocode}                                  % Pseudocode für Algorithmen

\usepackage{pgfplots}
\pgfplotsset{compat=1.8}
\usepackage{pgfplotstable}
\usetikzlibrary{arrows,patterns,shapes,trees,matrix}
\usepackage{microtype}
\usepackage[all]{nowidow}
\usepackage{attrib}

\usepackage[backend=biber, style=numeric, sorting=none, maxnames=10]{biblatex}
...
%        a4paper,                      % Option is no longer used
        ...
        pdfkeywords={Scan, SIMD, BitWeaving, ByteSlice},
        breaklinks,
        colorlinks,
        linkcolor=black,
        urlcolor=blue,
...
% Nuetzliche Macros
\newcommand{\bwv}{\emph{BitWeaving/V}}
\newcommand{\bs}{\emph{ByteSlice}}
\newcommand{\simdscan}{\emph{SIMD-Scan}}
