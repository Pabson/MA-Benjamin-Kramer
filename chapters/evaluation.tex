...
\addplot+[color=olive,only marks] table[header=false,col sep=semicolon, x index=2, y index=6] {data/BS_range_mini.csv};
\end{axis}
\end{tikzpicture}
...
\addplot+[color=olive,only marks] table[header=false,col sep=semicolon, x index=2, y index=8] {data/BS_range_mini.csv};
\end{axis}
\end{tikzpicture}
