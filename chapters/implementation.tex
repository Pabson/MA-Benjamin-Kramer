...
\bs{} paper. The implementation relies on unsigned integer comparisons; AVX~2
only supplies signed versions. To turn the signed versions into unsigned
compares all the sign bits had to be flipped as illustrated in
algorithm~\ref{algo:cmpunsigned}. This adds more instructions to the main scan
loop than was anticipated earlier.
